...
docker run -d -p 9000:9000 --name minio1 -e "MINIO_ACCESS_KEY=miniominio" -e "MINIO_SECRET_KEY=miniominio" minio/minio server /data --console-address ":9001" --address ":9000"
